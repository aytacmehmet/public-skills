...
| --- | --- | --- |
| PW01  Simple task | Current environment/model information is available. `/prompter Make this sentence more polite: Send the report today.` | One short prompt, model recommendation, and approval question; no rewritten sentence, tools, agents, or research yet. |
...
| PW05  Advance approval | `/prompter ... I approve in advance.` | Show the full prompt first and await a subsequent approval. |
