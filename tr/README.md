...
| --- | --- | --- |
| [Yordamla](yordamla/README.md) | İsteği sohbet bağlamına uygun prompta dönüştürür, onay ister ve aynı sohbette uygular. | [Prompter](../en/prompter/README.md) |
...
Türkçe ve İngilizce karşılıklar aynı sürümü ve davranışı paylaşır; adlar, yönergeler, açıklamalar ve belgeler ilgili dilde yazılır. Skill eklemeden veya güncelleme yayımlamadan önce [katkı ve sürüm yönetimini](CONTRIBUTING.md) okuyun.
