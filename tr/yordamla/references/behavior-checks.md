...
| --- | --- | --- |
| PW01  Basit iş | Güncel ortam/model bilgisi hazır. `/yordamla Şu cümleyi daha nazik yap: Raporu bugün gönder.` | Kısa tek prompt, model önerisi ve onay sorusu; henüz cümleyi dönüştürmez; araç/ajan/araştırma başlatmaz. |
...
| PW05  Ön onay | `/yordamla ... Şimdiden onaylıyorum.` | Önce tam promptu gösterir; daha sonra onay bekler. |
